...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine2() {
        // given
        LineAcceptanceStep.지하철_노선_등록되어_있음("신분당선", "bg-red-600", "400");
    ...
    void getLines() {
        ...
        ExtractableResponse<Response> createResponse1 = LineAcceptanceStep.지하철_노선_등록되어_있음("신분당선",
                "RED", "400");
        ExtractableResponse<Response> createResponse2 = LineAcceptanceStep.지하철_노선_등록되어_있음("2호선",
                "GREEN", "400");
    ...
    void updateLine() {
        // given
        String name = "신분당선";
        ExtractableResponse<Response> createResponse = LineAcceptanceStep.지하철_노선_등록되어_있음(name,
                "RED", "400");

        // when
        ExtractableResponse<Response> response = LineAcceptanceStep.지하철_노선_수정_요청(createResponse,
                "구분당선", "BLUE");
