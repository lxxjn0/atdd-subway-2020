...
public class LineStationRemoveAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        // given
        ExtractableResponse<Response> createLineResponse = LineAcceptanceStep.지하철_노선_등록되어_있음("2호선",
                "GREEN", "400");
        ExtractableResponse<Response> createdStationResponse1 = StationAcceptanceStep.지하철역_등록되어_있음(
                "강남역");
        ExtractableResponse<Response> createdStationResponse2 = StationAcceptanceStep.지하철역_등록되어_있음(
                "역삼역");
        ExtractableResponse<Response> createdStationResponse3 = StationAcceptanceStep.지하철역_등록되어_있음(
                "선릉역");
    ...
    void removeLineStation1() {
        // when
        ExtractableResponse<Response> deleteResponse = LineStationAcceptanceStep.지하철_노선에_지하철역_제외_요청(
                lineId, stationId3);
        ...
        LineStationAcceptanceStep.지하철_노선에_지하철역_순서_정렬됨(response,
                Arrays.asList(stationId1, stationId2));
    }
    ...
    void removeLineStation2() {
        ...
        LineStationAcceptanceStep.지하철_노선에_지하철역_순서_정렬됨(response,
                Arrays.asList(stationId1, stationId3));
    }
    ...
    void removeLineStation5() {
        // when
        ExtractableResponse<Response> response = LineStationAcceptanceStep.지하철_노선에_지하철역_제외_요청(
                lineId, 20L);
