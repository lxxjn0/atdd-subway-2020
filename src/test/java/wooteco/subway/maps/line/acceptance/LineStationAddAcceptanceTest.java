...
public class LineStationAddAcceptanceTest extends AcceptanceTest {
    ...
    void addLineStation() {
        // when
        // 지하철_노선에_지하철역_등록_요청
        ExtractableResponse<Response> response = LineStationAcceptanceStep.지하철_노선에_지하철역_등록_요청(
                lineId, null, stationId1);
    ...
    void addLineStationInOrder() {
        // when
        ExtractableResponse<Response> lineStationResponse = LineStationAcceptanceStep.지하철_노선에_지하철역_등록_요청(
                lineId, null, stationId1);
