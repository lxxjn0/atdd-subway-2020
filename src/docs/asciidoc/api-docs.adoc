...
operation::paths/find[snippets='http-request,http-response,request-parameters,response-body,response-fields']
...
operation::maps/find[snippets='http-request,http-response,response-body,response-fields']
